...
function Projects(){
    ...
    return(
        <section id="projects" ref={ref}>
            ...
            <ProjectView name="Casa Verde" linkExec="https://7-days-alura-day1-el4m98t1m-guiqsassi.vercel.app/" linkGit="https://github.com/guiqsassi/7DaysAlura-day1.git" techs={["React","Css", "Javascript"]} date="09/08/2023" description="Este projeto é uma landing page criada a partir de um projeto figma durante o desafio 7 days of code da alura" image={casaVerde}></ProjectView>
